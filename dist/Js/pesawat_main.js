...
function gameLoop(timestamp) {
    ...
    // Logika ini akan menangani reset lastTime menjadi 0
     if (lastTime === 0) {
        lastTime = timestamp;
...
restartButton.addEventListener('click', () => {
    resetGame(); // Pertama, reset semua status game
    requestAnimationFrame(gameLoop); // Kedua, mulai kembali game loop
});